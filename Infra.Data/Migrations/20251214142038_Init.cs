    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "لباس مناسب ورزش روزانه", "/Products/1.jpg", false, true, 4, 15, "لباس ورزشی", 350000L },
                    { 2, 2, "کفش حرفه‌ای راحتی", "/Products/2.jpg", false, true, 5, 8, "کفش اسپرت", 780000L },
                    { 3, 3, "ساعت هوشمند با امکانات کامل", "/Products/3.jpg", false, true, 4, 5, "ساعت هوشمند", 1250000L },
                    { 4, 1, "کیفیت بالا و باتری مناسب", "/Products/4.jpg", false, false, 3, 25, "هندزفری بیسیم", 420000L },
                    { 5, 1, "مناسب سفر و دانشگاه", "/Products/5.jpg", false, false, 4, 12, "کوله پشتی", 260000L },
                    { 6, 1, "کیبورد RGB حرفه‌ای", "/Products/6.jpg", false, false, 5, 7, "کیبورد گیمینگ", 690000L },
                    { 7, 2, "ماوس با حساسیت بالا", "/Products/7.jpg", false, false, 4, 18, "ماوس گیمینگ", 350000L },
                    { 8, 3, "مانیتور Full HD", "/Products/8.jpg", false, false, 5, 4, "مانیتور 24 اینچ", 3200000L },
                    { 9, 2, "قابلیت شارژ سریع", "/Products/9.jpg", false, false, 4, 20, "پاوربانک", 550000L },
                    { 10, 1, "کیفیت صدای بالا", "/Products/10.jpg", false, false, 5, 6, "هدفون حرفه‌ای", 980000L }
                });
